...
python yolov7/train.py --workers 160 --device 0,1,2,3 --sync-bn --batch-size 32 --epochs 18 --data custom.yaml --img 416 416 --cfg yolov7/cfg/training/yolov7.yaml --weights yolov7_training.pt --name yolov7_custom
